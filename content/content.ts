    ...
    items: {
      es: [
        ...
        },
        {
          ...
          type: "Fullstack / SaaS",
          status: "Publico",
          stack: ["Next.js", "TypeScript", "Tailwind CSS", "React Flow", "Vercel"],
          bullets: [
            "Editor visual de arquitectura de software: modela sistemas por capas (Application, Infrastructure, Data) con nodos y conexiones.",
            "Lienzo interactivo basado en React Flow: auto-layout de grupos, validacion de diagramas y exportacion a SVG/PNG/JSON.",
            "Multi-idioma (ES/EN), temas claro/oscuro y flujo de revision (borrador y envio para revision).",
          ],
          links: [
      ...
      en: [
        ...
        },
        {
          ...
          stack: ["Next.js", "TypeScript", "Tailwind CSS", "React Flow", "Vercel"],
          bullets: [
            "Visual software-architecture editor: model layered systems (Application, Infrastructure, Data) with nodes and connections.",
            "Interactive React Flow canvas: group auto-layout, diagram validation, and export to SVG/PNG/JSON.",
            "Multi-language (ES/EN), light/dark themes, and a review flow (draft and submit for review).",
          ],
          links: [
            { label: "Repo", href: "https://github.com/Leonard-ssj/ArchStudio" },
